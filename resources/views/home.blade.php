                    ...
                    <div class="row">
                      <div class="col-xs-12 col-md-2 ">
                        <ul class="nav  links nav-pills tabs-list  d-block d-sm-none">
                          ...
                          <li data-class=".recipes" role="presentation" class="fs12"><a href="#">recipes</a></li>
                        ...
                        <ul class="nav links nav-pills nav-stacked tabs-list d-none d-sm-block" >
                          ...
                          <li class=""role="presentation" data-class=".recipes"><a href="#">recipes</a></li>
                      ...
                      <div class="content-list col-xs-12 col-md-10">
                        ...
                        <div class=" recipes col-xs-12 col-md-10 toggles">
                          @if($posts->isNotEmpty())
                          ...
                          <a href="/allposts" class=" btn btn-primary btn-sm pull-right last-a"> more recipes</a>
                          </div>
                          <div class="secound-section">
                            ...
                            <a href="/allposts" class="text-center btn btn-primary btn-sm pull-right last-a">show more recipes</a>
                            @else
